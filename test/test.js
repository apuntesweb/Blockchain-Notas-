...
contract("Notas", (accounts) => {
    it("1. Funcion Evaluar", async () => {
        ...
        const tx1 = await instance.Evaluar("Biologia","12345X", 9, { from: accounts[0] });
        ...
        const nota_alumno = await instance.VerNotas.call("Biologia", "12345X", { from: accounts[1] });
    ...
    it("2. Revision", async () => {
        ...
        const rev1 = await instance.Revision("Biologia", "12345X", { from: accounts[1] });
        const rev2 = await instance.Revision("Biologia", "77755N", { from: accounts[1] });
